...
public class PingPongMain {
    ...
    public static void main(String[] args) {
        ...
        createInitialContracts(channel, ledgerId, aliceParty, bobParty, numInitialContracts, openTelemetry);
        createInitialContracts(channel, ledgerId, bobParty, aliceParty, numInitialContracts, openTelemetry);
     ...
     */
    private static void createInitialContracts(ManagedChannel channel, String ledgerId, String sender, String receiver, int numContracts, OpenTelemetryUtil openTelemetry) {
