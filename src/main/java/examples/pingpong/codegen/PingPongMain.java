...
public class PingPongMain {
    ...
    public static void main(String[] args) {
        ...
        PingPongProcessor aliceProcessor = new PingPongProcessor(aliceParty, channel, openTelemetry);
        PingPongProcessor bobProcessor = new PingPongProcessor(bobParty, channel, openTelemetry);
        ...
        createInitialContracts(channel, aliceParty, bobParty, numInitialContracts, openTelemetry);
        createInitialContracts(channel, bobParty, aliceParty, numInitialContracts, openTelemetry);
     ...
     */
    private static void createInitialContracts(ManagedChannel channel, String sender, String receiver, int numContracts, OpenTelemetryUtil openTelemetry) {
        ...
        for (int i = 0; i < numContracts; i++) {
            ...
            openTelemetry.runInNewSpan("createInitialContracts", () ->
